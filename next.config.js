...
const nextConfig = {
  ...
  env: {
    ...
    USERS_DATABASE_ID: process.env.USERS_DATABASE_ID,
    UPCOMING_APPOINTMENTS_COLLECTION_ID:
      process.env.UPCOMING_APPOINTMENTS_COLLECTION_ID,
    APPOINTMENT_HISTORIES_COLLECTION_ID:
    ...
    NEXT_PUBLIC_USERS_DATABASE_ID: process.env.NEXT_PUBLIC_USERS_DATABASE_ID,
    NEXT_PUBLIC_UPCOMING_APPOINTMENTS_COLLECTION_ID:
      process.env.NEXT_PUBLIC_UPCOMING_APPOINTMENTS_COLLECTION_ID,
    NEXT_PUBLIC_APPOINTMENT_HISTORIES_COLLECTION_ID:
